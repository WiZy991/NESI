...
export default function CertPage() {
  ...
  return (
    <div className="p-8 text-gray-100">
      <h1 className="text-2xl font-bold text-emerald-400 mb-6">🧾 Сертификация</h1>
      {categories.map((cat) => (
        <div key={cat.id} className="mb-6 bg-black/50 p-4 rounded-xl border border-emerald-500/30">
                ...
                <tr key={sub.id} className="border-b border-gray-800">
                  ...
                  <td>
                    <input
                      type="number"
                      value={sub.minPrice}
                      onChange={(e) => updatePrice(sub.id, Number(e.target.value))}
