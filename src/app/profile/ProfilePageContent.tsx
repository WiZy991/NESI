		...
		<div className='p-6 max-w-3xl mx-auto space-y-6'>
			...
			>
				...
				<p>
					...
					{profile.role === 'customer' ? 'Заказчик' : 'Исполнитель'}
				</p>
				{profile.location && (
					<p>
						<span className='text-gray-400'>Город:</span> {profile.location}
					</p>
				)}
			</div>
			...
			{/* Баланс */}
			<div
				className='p-4 bg-black/40 rounded-xl border border-emerald-500/30 
					...
					{reviews.length === 0 ? (
						...
						<div className='space-y-4'>
							{reviews.map(review => (
								<div
									key={review.id}
									className='bg-black/40 border border-emerald-500/30 
