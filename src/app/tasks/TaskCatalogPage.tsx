													...
													>
														<div className='flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4'>
															<div className='flex-1 min-w-0'>
																<h3 className='text-base font-semibold text-emerald-200 group-hover:text-emerald-100 transition-colors whitespace-normal break-normal line-clamp-2'>
																	{task.title}
																</h3>
															...
															<div
																className='relative flex flex-col items-end text-right gap-1 w-full sm:w-auto sm:min-w-[120px] sm:self-start px-1 sm:px-0 sm:shrink-0'
																onMouseLeave={() => {
															...
															>
																...
																<div className='relative w-full max-w-[80px] self-end h-[4px] rounded-full bg-emerald-500/15 border border-emerald-500/30 overflow-hidden shadow-[0_0_6px_rgba(16,185,129,0.25)]'>
																	<div
