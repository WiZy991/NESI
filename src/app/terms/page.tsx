			...
			<div className='space-y-6 sm:space-y-8'>
				...
				<div className='bg-black/40 border border-emerald-500/20 rounded-2xl p-6 sm:p-8 shadow-[0_0_25px_rgba(16,185,129,0.15)]'>
					...
					<div className='space-y-3 text-gray-300 leading-relaxed'>
						...
						<p>
							Первые 3 завершённые задачи — без комиссии (0%)! После этого
							комиссия составляет от 6% до 10% в зависимости от уровня Исполнителя.
							Комиссия автоматически вычитается при переводе средств Исполнителю.
						</p>
						<p className='text-sm text-gray-400 mt-3'>
							Пример (уровень 1-2, после бесплатных задач): при цене задачи 1000 ₽, 
							Исполнитель получает 900 ₽, Платформа получает 100 ₽ (10%).
						</p>
					</div>
				</div>
				...
				<div className='bg-black/40 border border-red-500/20 rounded-2xl p-6 sm:p-8 shadow-[0_0_25px_rgba(239,68,68,0.1)]'>
					<h2 className='text-2xl font-bold text-red-400 mb-4'>
						5. Запрещённые действия и товары/услуги
					</h2>
					<div className='space-y-4 text-gray-300 leading-relaxed'>
						<div>
							...
							<ul className='list-disc pl-6 space-y-2'>
								...
								<li>
									Незаконное использование объектов интеллектуальной
									собственности
								</li>
						...
						<div className='mt-4'>
							<p className='font-semibold text-red-400 mb-2'>
								5.2. Запрещённые категории товаров и услуг:
							</p>
							<p className='mb-3'>
								На Платформе <strong className='text-red-400'>СТРОГО
								ЗАПРЕЩЕНО</strong> размещать задания, связанные со следующими
								категориями:
							</p>
							<div className='bg-red-500/10 border border-red-500/30 rounded-xl p-4'>
								<ul className='list-disc pl-6 space-y-2 ml-2'>
									<li>
										<strong>Наркотические средства, психотропные
										вещества</strong> и их прекурсоры
									</li>
									<li>
									...
									<li>
										<strong>Азартные игры, букмекерские услуги</strong>,
										казино, тотализаторы
									</li>
									<li>
									...
									<li>
										<strong>Поддельные документы</strong>, дипломы,
										удостоверения, паспорта
									</li>
									<li>
										<strong>Пиратский контент</strong>: нелегальное ПО,
										фильмы, музыка, книги
									</li>
									<li>
									...
									<li>
										<strong>Услуги хакинга</strong>, взлома, DDoS-атак,
										вредоносное ПО
									</li>
									<li>
										<strong>Контрафактная продукция</strong>, поддельные
										товары
									</li>
									<li>
										<strong>Табачные изделия без лицензии</strong>,
										алкогольная продукция без разрешений
									</li>
									<li>
										<strong>Услуги по написанию дипломных работ</strong>,
										курсовых для учебных заведений
									</li>
									<li>
										<strong>Медицинские услуги без лицензии</strong>, продажа
										рецептурных лекарств
									</li>
									<li>
										<strong>Органы и ткани человека</strong>, услуги
										суррогатного материнства
									</li>
									<li>
										<strong>Экстремистские материалы</strong>, призывы к
										насилию, разжигание розни
									</li>
									<li>
