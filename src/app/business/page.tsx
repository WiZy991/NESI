...
export default function BusinessPage() {
  ...
  return (
    <main className="relative overflow-hidden text-white py-20 px-6">
      {/* 🔥 Только мягкое свечение без затемняющего квадрата */}
      <div className="absolute inset-0 blur-[200px] bg-[radial-gradient(circle_at_center,rgba(16,185,129,0.15),transparent_70%)]" />
