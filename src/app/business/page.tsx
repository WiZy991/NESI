...
<section className="relative max-w-4xl mx-auto mt-16 grid sm:grid-cols-2 gap-8">
  ...
  text: 'Через Подиум исполнителей вы можете находить лучших специалистов и приглашать их на постоянную работу в свою команду.',
    ...
    <div
      key={idx}
      className="p-6 bg-black/50 border border-emerald-700/40 rounded-2xl shadow-[0_0_20px_rgba(16,185,129,0.15)] hover:shadow-[0_0_25px_rgba(16,185,129,0.3)] transition-all duration-300 hover:scale-[1.02]"
    >
