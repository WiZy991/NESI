...
export default function Header() {
	...
	// УБРАНО: обновление при каждом изменении pathname вызывало постоянные ререндеры
	// Данные пользователя обновляются только при монтировании через UserContext
	// Для обновления после подтверждения компании используется refreshUser на странице настроек
										...
										{menuOpen && (
											...
											>
												...
												<div className='border-t border-emerald-500/20 py-2'>
													...
													{/* Портфолио и Команды - только для исполнителей */}
													{user.role === 'executor' && (
														<>
															<Link
																href='/portfolio'
