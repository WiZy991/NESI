        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6">
          {showForm ? (
            ...
            <div className="text-center py-8 text-gray-400">
              ...
              <p className="text-sm mt-2">Создайте первый шаблон для быстрой отправки сообщений</p>
            </div>
          ) : (
            <div className="space-y-3">
              {templates.map((template) => (
                <div
                  key={template.id}
                  className="p-4 bg-black/40 border border-emerald-500/20 rounded-lg hover:border-emerald-500/40 transition-all group"
                >
