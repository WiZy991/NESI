...
export const rateLimitConfigs = {
	...
	// Лимит для загрузки файлов - увеличен для множественных загрузок (как в Telegram)
	upload: {
		windowMs: 60 * 1000, // 1 минута
		maxRequests: 50, // Увеличено с 5 до 50 для быстрого добавления множества файлов
	},
}
